...
(function (Game) {
  ...
  const initialFrameCounterLimit = 7;
  let frameCounterLimit = initialFrameCounterLimit;
  ...
  function resetGame() {
    ...
    resetSnake();
    randomizeApple();
    frameCounterLimit = initialFrameCounterLimit;
  }
  ...
  function eatApple() {
    ...
    snake.color = `hsl(${hueColor}, 100%, 70%)`;
    ...
    frameCounterLimit = frameCounterLimit * 0.9;
  }
